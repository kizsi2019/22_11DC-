...
namespace maxkivalasztas
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("a legnagyobb elem indexe {0}, erteke {1}", legnagyobb_index, Tömb[legnagyobb_index]);
            Console.WriteLine("a legkisebb elem indexe {0}, erteke {1}", legkisebb_index, Tömb[legkisebb_index]);
            Console.ReadKey();
        }
    }
}
